...
In term of numbers parameters, ES-RNN uses about 500,000 parameters and N-BEATS with an hidden size of 256 and one stack of two blocks (trend and seasonal) has about 400,000 parameters.
