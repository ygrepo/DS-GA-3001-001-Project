...
\end{figure}
Dropout or batch normalization do not provide any significant improvement, the smoothing and normalization of the data seems enough for a convergence to a local minimum.
